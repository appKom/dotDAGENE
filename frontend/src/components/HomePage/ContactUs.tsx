import { CalendarIcon, EnvelopeIcon, MapPinIcon, PhoneIcon, UserGroupIcon } from "@heroicons/react/20/solid"

export const ContactUs = () => {
  return(
      <section className="bg-dotgreen flex w-full flex-col gap-4 border-3 border-black p-6 text-white">
